...
# Функция для получения списка vendorCode
def get_wb_vendor_codes(products: list[dict]) -> list[dict]:
    result = []
    for product in products:
        result.append(product['vendorCode'])
    return result
